...
Now, let's import the seaborn python library. The import() function helps to specify which Python libraries you would like to load into the current R session.
